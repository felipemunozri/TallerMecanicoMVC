...
var handleLineChart = function () {
	...
	$.ajax({
		...
		success: function (data) {
			var count = Object.keys(data.pActual).length;
			for (var i = 0; i < count; i++) {
				data.pActual[i].VentaTotalActual = agregarSeparadorMiles(data.pActual[i].VentaTotalActual);
				data.pActual[i].VentaTotalActual = parseFloat(data.pActual[i].VentaTotalActual);
			}
			count = Object.keys(data.pAnterior).length;
			for (var i = 0; i < count; i++) {
				data.pAnterior[i].VentaTotalAnterior = agregarSeparadorMiles(data.pAnterior[i].VentaTotalAnterior);
				data.pAnterior[i].VentaTotalAnterior = parseFloat(data.pAnterior[i].VentaTotalAnterior);
			}
			count = Object.keys(data.pTercero).length;
			for (var i = 0; i < count; i++) {
				data.pTercero[i].VentaTotalTercero = agregarSeparadorMiles(data.pTercero[i].VentaTotalTercero);
				data.pTercero[i].VentaTotalTercero = parseFloat(data.pTercero[i].VentaTotalTercero);
			}
			var options = {
				chart: {
					height: 350,
				...
				colors: [COLOR_BLUE, COLOR_ORANGE, COLOR_DARK],
				dataLabels: {
					enabled: true,
				},
				stroke: {
				...
				series: [{
					name: 'Periodo - 2021',
					data: [data.pActual[0].VentaTotalActual, data.pActual[1].VentaTotalActual, data.pActual[2].VentaTotalActual,
					data.pActual[4].VentaTotalActual]
				}, {
					name: 'Periodo - 2020',
					data: [data.pAnterior[0].VentaTotalAnterior, data.pAnterior[1].VentaTotalAnterior, data.pAnterior[2].VentaTotalAnterior,
					data.pAnterior[3].VentaTotalAnterior, data.pAnterior[4].VentaTotalAnterior, data.pAnterior[5].VentaTotalAnterior,
					data.pAnterior[6].VentaTotalAnterior, data.pAnterior[7].VentaTotalAnterior, data.pAnterior[8].VentaTotalAnterior,
					data.pAnterior[9].VentaTotalAnterior, data.pAnterior[10].VentaTotalAnterior, data.pAnterior[11].VentaTotalAnterior]
				}, {
					name: 'Periodo - 2019',
					data: [data.pTercero[0].VentaTotalTercero, data.pTercero[1].VentaTotalTercero, data.pTercero[2].VentaTotalTercero,
					data.pTercero[3].VentaTotalTercero, data.pTercero[4].VentaTotalTercero, data.pTercero[5].VentaTotalTercero,
					data.pTercero[6].VentaTotalTercero, data.pTercero[7].VentaTotalTercero, data.pTercero[8].VentaTotalTercero,
					data.pTercero[9].VentaTotalTercero, data.pTercero[10].VentaTotalTercero, data.pTercero[11].VentaTotalTercero]
				}],
				grid: {
					row: {
